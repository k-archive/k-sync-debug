...
SubmitRequest.prototype.submit = function(callback) { console.log('SubmitRequest.submit')
  var request = this;
...
SubmitRequest.prototype.apply = function(callback) { console.log('SubmitRequest.apply')
...
SubmitRequest.prototype.commit = function(callback) { console.log('SubmitRequest.commit')
  var request = this;
  var backend = this.backend;
...
SubmitRequest.prototype.retry = function(callback) { console.log('SubmitRequest.retry')
  this.retries++;
...
SubmitRequest.prototype._transformOp = function(ops) { console.log('SubmitRequest._transformOp')
...
SubmitRequest.prototype._addOpMeta = function() { console.log('SubmitRequest._addOpMeta')
  this.op.m = {
    ts: this.start
  };
  if (this.op.create) {
...
SubmitRequest.prototype._addSnapshotMeta = function() { console.log('SubmitRequest._addSnapshotMeta')
...
SubmitRequest.prototype.alreadySubmittedError = function() { console.log('SubmitRequest.alreadySubmittedError')
  return {code: 4001, message: 'Op already submitted'};
};
SubmitRequest.prototype.rejectedError = function() { console.log('SubmitRequest.rejectedError')
  return {code: 4002, message: 'Op submit rejected'};
};
// Fatal client errors:
SubmitRequest.prototype.alreadyCreatedError = function() { console.log('SubmitRequest.alreadyCreatedError')
  return {code: 4010, message: 'Invalid op submitted. Document already created'};
};
SubmitRequest.prototype.newerVersionError = function() { console.log('SubmitRequest.newerVersionError')
  return {code: 4011, message: 'Invalid op submitted. Op version newer than current snapshot'};
};
SubmitRequest.prototype.projectionError = function() { console.log('SubmitRequest.projectionError')
  return {code: 4012, message: 'Invalid op submitted. Operation invalid in projected collection'};
};
// Fatal internal errors:
SubmitRequest.prototype.missingOpsError = function() { console.log('SubmitRequest.missingOpsError')
  return {code: 5001, message: 'Op submit failed. DB missing ops needed to transform it up to the current snapshot version'};
};
SubmitRequest.prototype.versionDuringTransformError = function() { console.log('SubmitRequest.versionDuringTransformError')
  return {code: 5002, message: 'Op submit failed. Versions mismatched during op transform'};
};
SubmitRequest.prototype.versionAfterTransformError = function() { console.log('SubmitRequest.versionAfterTransformError')
  return {code: 5003, message: 'Op submit failed. Op version mismatches snapshot after op transform'};
};
SubmitRequest.prototype.maxRetriesError = function() { console.log('SubmitRequest.maxRetriesError')
