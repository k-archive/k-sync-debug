...
MemoryDB.prototype.close = function(callback) { console.log('MemoryDB.close')
  this.closed = true;
...
MemoryDB.prototype.commit = function(collection, id, op, snapshot, callback) { console.log('MemoryDB.commit')
  var db = this;
...
MemoryDB.prototype.getSnapshot = function(collection, id, fields, callback) { console.log('MemoryDB.getSnapshot')
  var db = this;
  process.nextTick(function() {
...
MemoryDB.prototype.getOps = function(collection, id, from, to, callback) { console.log('MemoryDB.getOps')
  var db = this;
  process.nextTick(function() {
...
MemoryDB.prototype.query = function(collection, query, fields, options, callback) { console.log('MemoryDB.query')
  var db = this;
  process.nextTick(function() {
...
MemoryDB.prototype._querySync = function(snapshots, query, options) { console.log('MemoryDB._querySync')
  return snapshots;
};


MemoryDB.prototype._writeOpSync = function(collection, id, op) { console.log('MemoryDB._writeOpSync')
...
MemoryDB.prototype._writeSnapshotSync = function(collection, id, snapshot) { console.log('MemoryDB._writeSnapshotSync')
...
MemoryDB.prototype._getSnapshotSync = function(collection, id) { console.log('MemoryDB._getSnapshotSync')
...
MemoryDB.prototype._getOpLogSync = function(collection, id) { console.log('MemoryDB._getOpLogSync')
  var collectionOps = this.ops[collection] || (this.ops[collection] = {});
  return collectionOps[id] || (collectionOps[id] = []);
};

MemoryDB.prototype._getVersionSync = function(collection, id) { console.log('MemoryDB._getVersionSync')
