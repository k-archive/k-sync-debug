...
StreamSocket.prototype._open = function() { console.log('StreamSocket._open')
  if (this.readyState !== 0) return;
  this.readyState = 1;
  this.onopen();
};
StreamSocket.prototype.close = function(reason) { console.log('StreamSocket.close')
...
StreamSocket.prototype.send = function(data) { console.log('StreamSocket.send')
  // Data is an object
...
ServerStream.prototype._write = function(chunk, encoding, callback) { console.log('ServerStream._write')
