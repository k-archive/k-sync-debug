...
QueryEmitter.prototype._open = function() { console.log('QueryEmitter._open')
  var emitter = this;
...
QueryEmitter.prototype.destroy = function() { console.log('QueryEmitter.destroy')
  clearTimeout(this._pollDebounceId);
  clearTimeout(this._pollIntervalId);
  this.stream.destroy();
};

QueryEmitter.prototype.updateQuery = function(query, ids){ console.log('QueryEmitter.updateQuery')
...
QueryEmitter.prototype._emitTiming = function(action, start) { console.log('QueryEmitter._emitTiming')
  this.backend.emit('timing', action, Date.now() - start, this);
};

QueryEmitter.prototype._update = function(op) { console.log('QueryEmitter._update')
  var id = op.d;
...
QueryEmitter.prototype._flushPoll = function() { console.log('QueryEmitter._flushPoll')
...
QueryEmitter.prototype.queryPoll = function(callback) { console.log('QueryEmitter.queryPoll')
  var emitter = this;
...
QueryEmitter.prototype._finishPoll = function(err, callback, pending) { console.log('QueryEmitter._finishPoll')
  this._polling = false;
...
QueryEmitter.prototype.queryPollDoc = function(id, callback) { console.log('QueryEmitter.queryPollDoc')
  var emitter = this;
  var start = Date.now();
...
QueryEmitter.prototype.onOp = function() { console.log('QueryEmitter.onOp')
