...
Doc.prototype.destroy = function(callback) { console.log('Doc.destroy')
  var doc = this;
...
Doc.prototype.digest = function() { console.log('Doc.digest')
...
Doc.prototype._setType = function(newType) { console.log('Doc._setType')
...
// @param snapshot.type
// @param callback
Doc.prototype.ingestSnapshot = function(snapshot, callback) { console.log('Doc.ingestSnapshot')
...
Doc.prototype.whenNothingPending = function(callback) { console.log('Doc.whenNothingPending')
  if (this.hasPending()) {
...
Doc.prototype.hasPending = function() { console.log('Doc.hasPending')
  return !!(
    this.inflightOp ||
...
Doc.prototype.hasWritePending = function() { console.log('Doc.hasWritePending')
  return !!(this.inflightOp || this.pendingOps.length);
};

Doc.prototype._emitNothingPending = function() { console.log('Doc._emitNothingPending')
...
Doc.prototype._emitResponseError = function(err, callback) { console.log('Doc._emitResponseError')
  if (callback) {
    callback(err);
...
Doc.prototype._handleFetch = function(err, snapshot) { console.log('Doc._handleFetch')
...
Doc.prototype._handleSubscribe = function(err, snapshot) { console.log('Doc._handleSubscribe')
...
Doc.prototype._handleUnsubscribe = function(err) { console.log('Doc._handleUnsubscribe')
...
Doc.prototype._handleOp = function(err, message) { console.log('Doc._handleOp')
  if (err) {
    if (this.inflightOp) {
...
Doc.prototype._onConnectionStateChanged = function() { console.log('Doc._onConnectionStateChanged')
...
Doc.prototype._resubscribe = function() { console.log('Doc._resubscribe')
...
Doc.prototype.fetch = function(callback) { console.log('Doc.fetch')
  if (this.connection.canSend) {
...
Doc.prototype.subscribe = function(callback) { console.log('Doc.subscribe')
...
// receiving updates
Doc.prototype.unsubscribe = function(callback) { console.log('Doc.unsubscribe')
  this.wantSubscribe = false;
...
Doc.prototype.flush = function() { console.log('Doc.flush')
 ...
 * @private
 */
Doc.prototype._otApply = function(op, source) { console.log('Doc._otApply')
  if (op.op) {
    if (!this.type) {
...
Doc.prototype._sendOp = function() { console.log('Doc._sendOp')
...
Doc.prototype._submit = function(op, source, callback) { console.log('Doc._submit')
...
Doc.prototype._pushOp = function(op, callback) { console.log('Doc._pushOp')
  if (this.applyStack) {
...
Doc.prototype._popApplyStack = function(to) { console.log('Doc._popApplyStack')
  if (to > 0) {
...
Doc.prototype._tryCompose = function(op) { console.log('Doc._tryCompose')
...
Doc.prototype.submitOp = function(op, source, callback) { console.log('Doc.submitOp')
...
Doc.prototype.create = function(data, type, source, callback) { console.log('Doc.create')
...
// @param source
// @param callback  called when operation submitted
Doc.prototype.del = function(source, callback) { console.log('Doc.del')
  if (typeof source === 'function') {
    callback = source;
    source = null;
  }
...
Doc.prototype.pause = function() { console.log('Doc.pause')
  this.paused = true;
};

// Continue sending operations to the server
Doc.prototype.resume = function() { console.log('Doc.resume')
  this.paused = false;
  this.flush();
};
...
Doc.prototype._opAcknowledged = function(message) { console.log('Doc._opAcknowledged')
...
Doc.prototype._rollback = function(err) { console.log('Doc._rollback')
...
Doc.prototype._hardRollback = function(err) { console.log('Doc._hardRollback')
...
Doc.prototype._clearInflightOp = function(err) { console.log('Doc._clearInflightOp')
