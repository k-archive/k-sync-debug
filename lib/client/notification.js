...
Notification.prototype._handleSubscribe = function(err, data, extra) { console.log('Notification._handleSubscribe')
...
Notification.prototype._handleFetch = function(err, data, extra) { console.log('Notification._handleFetch')
  var callback = this.callback;
  this.callback = null;
...
Notification.prototype._handleDiff = function(diff) { console.log('Notification._handleDiff')
...
Notification.prototype.submitOp = function(op, callback) { console.log('Notification.submitOp')
...
Notification.prototype.handleOp = function(op) { console.log('Notification.handleOp')
