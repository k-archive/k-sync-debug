 ...
 */
Connection.prototype.bindToSocket = function(socket) { console.log('Connection.bindToSocket')
  if (this.socket) {
    this.socket.close();
 ...
 */
Connection.prototype.handleMessage = function(message) { console.log('Connection.handleMessage')
...
Connection.prototype._handleBulkMessage = function(message, method) { console.log('Connection._handleBulkMessage')
  if (message.data) {
...
Connection.prototype._reset = function() { console.log('Connection._reset')
  this.seq = 1;
  this.id = null;
  this.agent = null;
};
...
Connection.prototype._setState = function(newState, reason) { console.log('Connection._setState')
...
Connection.prototype.startBulk = function() { console.log('Connection.startBulk')
  if (!this.bulk) this.bulk = {};
};

Connection.prototype.endBulk = function() { console.log('Connection.endBulk')
  if (this.bulk) {
...
Connection.prototype._sendBulk = function(action, collection, values) { console.log('Connection._sendBulk')
  if (!values) return;
  var ids = [];
  var versions = {};
  var versionsCount = 0;
...
Connection.prototype._sendAction = function(action, doc, version) { console.log('Connection._sendAction')
...
Connection.prototype.sendFetch = function(doc) { console.log('Connection.sendFetch')
  return this._sendAction('f', doc, doc.version);
};

Connection.prototype.sendSubscribe = function(doc) { console.log('Connection.sendSubscribe')
  return this._sendAction('s', doc, doc.version);
};

Connection.prototype.sendUnsubscribe = function(doc) { console.log('Connection.sendUnsubscribe')
  return this._sendAction('u', doc);
};

Connection.prototype.sendOp = function(doc, op) { console.log('Connection.sendOp')
  // Ensure the doc is registered so that it receives the reply message
  this._addDoc(doc);
  var message = {
    a: 'op',
 ...
 */
Connection.prototype.send = function(message) { console.log('Connection.send')
 ...
 */
Connection.prototype.close = function() { console.log('Connection.close')
  this.socket.close();
};

Connection.prototype.getExisting = function(collection, id) { console.log('Connection.getExisting')
 ...
 * @return {Doc}
 */
Connection.prototype.get = function(collection, id) { console.log('Connection.get')
  var docs = this.collections[collection] ||
 ...
 * @private
 */
Connection.prototype._destroyDoc = function(doc) { console.log('Connection._destroyDoc')
...
Connection.prototype._addDoc = function(doc) { console.log('Connection._addDoc')
  var docs = this.collections[doc.collection],
...
Connection.prototype.createRPC = function(name, params, callback) { console.log('Connection.createRPC')
  this.rpc[name] = new RPC(name, params, this, callback);
};

Connection.prototype._createQuery = function(action, collection, q, options, callback) { console.log('Connection._createQuery')
...
Connection.prototype._destroyQuery = function(query) { console.log('Connection._destroyQuery')
...
Connection.prototype.createFetchQuery = function(collection, q, options, callback) { console.log('Connection.createFetchQuery')
...
// where results is a list of Doc objects.
Connection.prototype.createSubscribeQuery = function(collection, q, options, callback) { console.log('Connection.createSubscribeQuery')
  return this._createQuery('s', collection, q, options, callback);
};

Connection.prototype.hasPending = function() { console.log('Connection.hasPending')
  return !!(
...
Connection.prototype.hasWritePending = function() { console.log('Connection.hasWritePending')
...
Connection.prototype.whenNothingPending = function(callback) { console.log('Connection.whenNothingPending')
...
Connection.prototype._nothingPendingRetry = function(callback) { console.log('Connection._nothingPendingRetry')
  var connection = this;
  return function() {
    process.nextTick(function() {
...
Connection.prototype._firstDoc = function(fn) { console.log('Connection._firstDoc')
  for (var collection in this.collections) {
    var docs = this.collections[collection];
    for (var id in docs) {
      var doc = docs[id];
...
Connection.prototype._firstQuery = function(fn) { console.log('Connection._firstQuery')
  for (var id in this.queries) {
    var query = this.queries[id];
    if (fn(query)) {
      return query;
