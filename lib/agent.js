...
Agent.prototype.close = function(err) { console.log('Agent.close')
  if (err) {
...
Agent.prototype._cleanup = function() { console.log('Agent._cleanup')
  this.closed = true;
 ...
 * _sendOp()
 */
Agent.prototype._subscribeToStream = function(collection, id, stream) { console.log('Agent._subscribeToStream')
...
Agent.prototype.getExistingEmitter = function(queryId) { console.log('Agent.getExistingEmitter')
  return this.subscribedQueries[queryId];
}

Agent.prototype._subscribeToQuery = function(emitter, queryId, collection, query) { console.log('Agent._subscribeToQuery')
...
Agent.prototype._isOwnOp = function(collection, op) { console.log('Agent._isOwnOp')
...
Agent.prototype.send = function(message) { console.log('Agent.send')
...
Agent.prototype._sendOp = function(collection, id, op) { console.log('Agent._sendOp')
  var message = {
    a: 'op',
    c: collection,
    d: id,
...
Agent.prototype._sendOps = function(collection, id, ops) { console.log('Agent._sendOps')
  for (var i = 0; i < ops.length; i++) {
    this._sendOp(collection, id, ops[i]);
  }
};

Agent.prototype._reply = function(request, err, message) { console.log('Agent._reply')
  if (err) {
...
Agent.prototype._open = function() { console.log('Agent._open')
  if (this.closed) return;
...
Agent.prototype._checkRequest = function(request) { console.log('Agent._checkRequest')
...
Agent.prototype._handleMessage = function(request, callback) { console.log('Agent._handleMessage')
...
Agent.prototype._rpc = function(name, params, callback) { console.log('Agent._rpc')
...
Agent.prototype._functionFetch = function(queryId, collection, query, options, callback) { console.log('Agent._functionFetch')
...
Agent.prototype._queryFetch = function(queryId, collection, query, options, callback) { console.log('Agent._queryFetch')
  // Fetch the results of a query once
  var agent = this;
...
Agent.prototype._pathquerySubscribe = function(queryId, collection, query, options, callback) { console.log('Agent._pathquerySubscribe')
...
Agent.prototype._querySubscribe = function(queryId, collection, query, options, callback) { console.log('Agent._querySubscribe')
...
Agent.prototype._queryUnsubscribe = function(queryId, callback) { console.log('Agent._queryUnsubscribe')
...
Agent.prototype._fetch = function(collection, id, version, callback) { console.log('Agent._fetch')
  if (version == null) {
    // Fetch a snapshot
...
Agent.prototype._fetchOps = function(collection, id, version, callback) { console.log('Agent._fetchOps')
  var agent = this;
...
Agent.prototype._fetchBulk = function(collection, versions, callback) { console.log('Agent._fetchBulk')
...
Agent.prototype._fetchBulkOps = function(collection, versions, callback) { console.log('Agent._fetchBulkOps')
  var agent = this;
...
Agent.prototype._subscribe = function(collection, id, version, callback) { console.log('Agent._subscribe')
...
Agent.prototype._subscribeBulk = function(collection, versions, callback) { console.log('Agent._subscribeBulk')
  var agent = this;
...
Agent.prototype._unsubscribe = function(collection, id, callback) { console.log('Agent._unsubscribe')
...
Agent.prototype._unsubscribeBulk = function(collection, ids, callback) { console.log('Agent._unsubscribeBulk')
  var docs = this.subscribedDocs[collection];
...
Agent.prototype._submit = function(collection, id, op, callback) { console.log('Agent._submit')
  var agent = this;
...
Agent.prototype._createOp = function(request) { console.log('Agent._createOp')
