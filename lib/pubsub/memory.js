...
MemoryPubSub.prototype._subscribe = function(channel, callback) { console.log('MemoryPubSub._subscribe')
  if (callback) process.nextTick(callback);
};

MemoryPubSub.prototype._unsubscribe = function(channel, callback) { console.log('MemoryPubSub._unsubscribe')
  if (callback) process.nextTick(callback);
};

MemoryPubSub.prototype._publish = function(channels, data, callback) { console.log('MemoryPubSub._publish')
  var pubsub = this;
