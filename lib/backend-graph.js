...
Backend.prototype.graphSubscribe = function(agent, to, options, callback){ console.log('Backend.graphSubscribe')
...
Backend.prototype.graphFetch = function(agent, to, options, callback){ console.log('Backend.graphFetch')
  var db = this.db,
      backend = this,
      start = Date.now();
...
Backend.prototype.submitGop = function(agent, op, callback){ console.log('Backend.submitGop')
...
SubmitGopRequest.prototype.run = function(callback){ console.log('SubmitGopRequest.run')
  var op = this.op;
