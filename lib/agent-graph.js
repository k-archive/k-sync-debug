...
Agent.prototype._graphSubscribe = function(req, callback){ console.log('Agent._graphSubscribe')
...
Agent.prototype._graphUnsubscribe = function(req, callback){ console.log('Agent._graphUnsubscribe')
...
Agent.prototype._subscribeToGraph = function(emitter, queryId, graphName, vertex){ console.log('Agent._subscribeToGraph')
...
Agent.prototype._graphFetch = function(req, callback){ console.log('Agent._graphFetch')
  var parsed = util.parseGraphCollection(req, this.backend.projections),
      agent = this;
...
Agent.prototype._submitGop = function(req, callback){ console.log('Agent._submitGop')
